export const work = [
  {
    ...
    company: "Zurich, grape insurance",
    country: "Switzerland",
    workload: "Full time",
    start: new Date(2024, 10),
    end: "Present",
    content: `<ul class="ml-8 list-disc">
      <li>Collaborated with internal claiming team on improving their operations delivering key functionalities for their day-to-day tasks and quality of life features.</li>
      <li>Developed a payment solution including integration with UBS and automatic calculation of claims</li>
    </ul>
    `,
    keywords: [
      "TypeScript",
